...
-------------------------------------------------
ALTER TABLE DOCGIA
ADD CONSTRAINT CHK_LIENHE CHECK(LEN(LIENHE) = 10)

ALTER TABLE NHAXUATBAN
ADD CONSTRAINT U_TENNXB UNIQUE(TENNXB)

ALTER TABLE LOAISACH
ADD CONSTRAINT U_LOAISACH UNIQUE(TENLOAI)

ALTER TABLE MUONTRASACH
ADD CONSTRAINT DF_NGAYTRA DEFAULT 'NULL' FOR NGAYTRA

CREATE TRIGGER TGR_CHECK_NGAYTRA ON MUONTRASACH
AFTER INSERT, UPDATE
AS
	BEGIN 
	END